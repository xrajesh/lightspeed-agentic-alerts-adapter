## Purpose
Compute a stable fingerprint from alert labels for deduplication, ensuring alerts that represent the same underlying problem produce the same hash regardless of ephemeral label differences.
